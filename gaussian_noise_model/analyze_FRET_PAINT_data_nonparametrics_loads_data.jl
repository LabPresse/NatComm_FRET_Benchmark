...
function sampler_HMM(draws)
    ...
    mcmc_save_variance_donor::Matrix{Float64} = zeros(draws, max_n_system_states)
    mcmc_save_variance_acceptor::Matrix{Float64} = zeros(draws, max_n_system_states)
    ...
    mcmc_save_MAP_trajectory::Vector{Int64} =
        check_existing_mcmc_data(mcmc_save_loads,
            mcmc_save_rates,
            mcmc_save_mean_donor,
            mcmc_save_mean_acceptor,
            mcmc_save_variance_donor,
            mcmc_save_variance_acceptor,
            mcmc_log_posterior,
    ...
    if last_draw == 1
        ...
        mean_acceptor, variance_acceptor = initialize_variables()
        ...
        mcmc_log_posterior[last_draw] =
            get_log_posterior(loads, rates, mean_donor, variance_donor,
        ...
        mcmc_save_variance_donor[last_draw, :] = variance_donor
        mcmc_save_variance_acceptor[last_draw, :] = variance_acceptor
    else
        ...
        variance_donor = mcmc_save_variance_donor[last_draw, :]
        variance_acceptor = mcmc_save_variance_acceptor[last_draw, :]
    end
    ...
    for draw in last_draw+1:draws
        ...
        mean_acceptor, variance_acceptor = sample_emission_parameters(
            draw, loads, rates,
            state_trajectory, mean_donor, variance_donor,
            mean_acceptor, variance_acceptor,
            temperature)
        ...
        mcmc_save_variance_donor[draw, :] = variance_donor
        mcmc_save_variance_acceptor[draw, :] = variance_acceptor
        ...
        @show variance_donor[loads_active]
        @show variance_acceptor[loads_active]
        ...
        save_mcmc_data(draw, mcmc_save_loads, mcmc_save_rates,
            ...
            mcmc_save_variance_donor,
            mcmc_save_mean_acceptor, mcmc_save_variance_acceptor)
