...
#file_id = ARGS[1]
#file_prefix = string("filtered_acceptor_bleaching_traces_", file_id)
working_directory = string("/home/singularity/Dropbox (ASU)/bayesianCodes/julia/multiFRET/BNP-FRET_binned/gaussian/")
...
const da_crosstalk::Float64 = 0.07
